...
csvFile = 'cms_datasets_11_19_2014.csv'
xmlFile = 'cms.bib'
...
for row in csvDict:
    ...
    xmlData.write('## Bib file created from cms CSV\n')
    # variables: name,origin_name_,sponsor_name_,sector_name_,period_name_,reference_period_name_,unit_of_enumeration_name_,organization_name_,administrative_data,legal_authority,observations,industry_name_,naics_coverage,documentation_url,short_description,long_description,limitations,fti,id,id_18
